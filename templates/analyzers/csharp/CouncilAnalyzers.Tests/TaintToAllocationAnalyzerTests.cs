// <copyright file="TaintToAllocationAnalyzerTests.cs" company="Council of Experts">
//     SPDX-FileCopyrightText: 2026 snapetech
//     SPDX-License-Identifier: MIT
// </copyright>

namespace CouncilAnalyzers.Tests
{
    using System;
